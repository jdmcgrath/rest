...
import (
	...
	"github.com/jdmcgrath/rest/examples/stdlib/handlers/topic/post"
	"github.com/jdmcgrath/rest/examples/stdlib/handlers/topics/get"
...
func main() {
	...
	api.StripPkgPaths = []string{"github.com/jdmcgrath/rest/example", "github.com/a-h/respond"}
